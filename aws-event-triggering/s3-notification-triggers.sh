...
bucket_name="vaishnavi453-ultimate-bucket"
lambda_func_name="s3-lambda-function"
role_name="s3-lambda-sns"
email_address="vaishnaviburadkar123@gmail.com"
...
aws sns publish \
  ...
  --message "Hello from Vaishnavi.Buradkar, Thank you Abhishek Veeramalla for your dedication and guidance"
